...
describe("<CitySearch /> component", () => {
  ...
  test("render text input", () => {
    expect(CitySearchWrapper.find(".searchBar")).toHaveLength(1);
  });
  ...
  test("renders text input correctly", () => {
    ...
    expect(CitySearchWrapper.find(".searchBar").prop("value")).toBe(query);
  });
  ...
  test("change state when text input changes", () => {
    ...
    CitySearchWrapper.find(".searchBar").simulate("change", eventObject);
  ...
  test("selecting CitySearch input reveals the suggestions list", () => {
    CitySearchWrapper.find(".searchBar").simulate("focus");
